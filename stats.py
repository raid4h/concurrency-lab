...
DEMO_TYPES = ["producer_consumer", "dining_philosophers", "multiprocess_counter", "readers_writers"]
...
def build_stats_figure():
    ...
    fig = Figure(figsize=(6.5, 14.5), dpi=100, constrained_layout=True)
    ...
    ax5.bar(["Safe", "Unsafe"],
            ...
            color=["#6a994e", "#bc4749"])
    ax5.set_title("Overlap Violations (Readers-Writers)", fontsize=10)
